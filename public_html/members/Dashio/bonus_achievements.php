  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i> Bonus Achievements</h3>
        <!-- row -->
        <div class="row mt">
          <div class="col-md-12">
            <div class="content-panel">
              <table class="table table-striped table-advance table-hover">
                <h4><i class="fa fa-angle-right"></i> Bonus Achievements</h4>
                <hr>
                <thead>
                  <tr>
                    <th><i class="fa fa-bullhorn"></i> User</th>
                    <th class="hidden-phone"><i class="fa fa-question-circle"></i> Bunos Achievements</th>
                    <th></th>
                  </tr>
                </thead>
                <tbody>
                   <?php
								...
								$h=mysqli_query($db,"select * from bunos order by bunos_count desc");
								while($hrow=mysqli_fetch_array($h)){
								    $uid = $hrow['userid'];
								    $hs=mysqli_query($db,"select * from user where account ='$uid'");
								    $user = mysqli_fetch_array($hs);
									?>
										<tr>
											<td><?php echo $hrow['userid']; ?></td>
											<td><?php echo $user['first_name']; echo ' '; echo $user['last_name']; ?></td>
											<td><span class="label label-warning label-mini"><?php  echo ($hrow['active1']+$hrow['active2']+$hrow['active3']+$hrow['active4']+$hrow['active5']+$hrow['active6']) ?></span></td>
										     <td>
                                              <button class="btn btn-success btn-xs" onclick="location.href='profile.php?userid=<?php echo $hrow['userid']; ?>'"><i class="fa fa-check"></i> Visit </button>
