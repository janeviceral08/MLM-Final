  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i> Payout Requests</h3>
        <!-- row -->
        <div class="row mt">
          <div class="col-md-12">
            <div class="content-panel">
              <table class="table table-striped table-advance table-hover">
                <h4><i class="fa fa-angle-right"></i> Payout Requests</h4>
                <hr>
                <thead>
                  <tr>
                                    <th><i class="fa fa-bullhorn"></i>S.n.</th>
                                    <th><i class=" fa fa-edit"></i> Userid</th>
                                    <th><i class=" fa fa-edit"></i> Mode</th>
                                    <th><i class=" fa fa-edit"></i> Details</th>
                                    <th><i class=" fa fa-edit"></i> Amount</th>
                                    <th><i class=" fa fa-edit"></i> Fee</th>
                                    <th><i class=" fa fa-edit"></i> Date Processed</th>
                ...
                <tbody>
                        <?php
                                 include('connect.php');
									...
									$query = mysqli_query($db,"select * from payout_request where status='pending'");
									if(mysqli_num_rows($query)>0){
										...
										?>
                                        	<tr>
                                               ...
                                               <td><a href="payout_info.php?id=<?php echo $row["id"]; ?>"> Process </a></td>
