        ...
        <div id="page-wrapper">
            <div class="container-fluid">
              ...
              <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <!--
                          <form method="POST" action="report-user-list.php" class="form-inline">
...
<div class="table-responsive">
					<table width="100%" class="table table-striped table-bordered table-hover" id="historyTable">
						...
						<tbody>
							<?php
								$h=mysqli_query($con,"select * from questions where status='Answered' order by date_questioned asc");
								while($hrow=mysqli_fetch_array($h)){
									?>
										<tr>
											<td class="hidden"></td>
												<td><?php echo $hrow['name']; ?></td>
                                                <td><?php echo $hrow['emails']; ?></td>
                                                <td><?php echo $hrow['question']; ?></td>
                                              
                                                <td><?php echo date("M d, Y - h:i A", strtotime($hrow['date_questioned'])); ?></td>
                                                <td><?php echo $hrow['answer']; ?></td>
                                              
                                                <td><?php echo date("M d, Y - h:i A", strtotime($hrow['date_answered'])); ?></td>
