     ...
     <div class="row" style="margin: auto">
                ...
                <div class="col-lg-12">
					...
					<table width="100%" class="table table-striped table-bordered table-hover" id="historyTable">
						...
						<tbody>
					 <?php
									$query = mysqli_query($con,"select * from online_reg where id='$id'");
   ...
   <br>
  	<?php 
							...
							if(mysqli_num_rows($query)>0){
								...
								?>
			<form method="POST" action="approve_online_reg.php" enctype="multipart/form-data">
			    	<div class="form-group" >
					<label>User id:</label>
					<input type="text" class="form-control" name="id" value="<?php echo $row['id'] ?>" readonly>
				</div>
					<div class="form-group">
					<label>Upline Email:</label>
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" name="tracking" value="<?php echo $row['tracking_num'] ?>" required>
				</div>
				<div class="form-group">
					<label>Expected Date To arrive:</label>
					<input type="date" class="form-control" name="date_to_arrive" required>
				</div>
					<div class="form-group">
				...
				<input type="submit" name="send" class="btn btn-primary" id='myBtn' value="Send For Delivery">
			</form>
			<?php
