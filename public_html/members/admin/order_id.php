        ...
        <div id="page-wrapper">
            <div class="container-fluid">
              ...
              <!-- /.row -->
                ...
                <div class="col-lg-12">
                    	<a href="modal_hist.php?rowid=<?php echo $hrow['tr_id']; ?>" style="margin-bottom: 12px" data-toggle="modal" class="btn btn-primary btn-sm"><span class="glyphicon glyphicon-plus"></span> Add Order id</a>
					...
					<table width="100%" class="table table-striped table-bordered table-hover" id="historyTable">
						...
						<tbody>
							<?php
								$h=mysqli_query($con,"select * from order_history_details where status='To be Process' order by date_transac desc");
