...
$userid = $_POST['userid'];
								...
								$h=mysqli_query($con,"SELECT * FROM customer_order LEFT JOIN order_history_details ON customer_order.tr_id=order_history_details.tr_id where date_process between '$from' and '$to' and uid='$userid'");
