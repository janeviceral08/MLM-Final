...
<div class="table-responsive" id="historyTables">
					<table width="100%" class="table table-striped table-bordered table-hover" id="historyTable">
						...
						<tbody>
							<?php
								$h=mysqli_query($con,"select * from user ");
								while($hrow=mysqli_fetch_array($h)){
									?>
										<tr>
											...
											<td><?php echo $hrow['mobile']; ?></td>
											<td><?php echo $hrow['address']; ?></td>
											<td><?php echo $hrow['under_userid']; ?></td>
											<td><?php echo $hrow['account']; ?></td>
											<td><?php echo $hrow['password']; ?></td>
											<td><?php echo date("M d, Y", strtotime($hrow['date_entered']));?></td>
