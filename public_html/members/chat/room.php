...
$get_userids = mysqli_query($con,"select * from user where account='$get_userid'");
	...
	$time = time();
     ...
     $query = mysqli_query($con,"insert into message(`messages`,`userid`,`date_sent`,`status`,`to_receiver`) values('$chat_msg','$email', NOW(),'unread','admin')");
...
?>
			...
			<div class="input-group" >
					<textarea type="text" class="form-control" style="font-size:20px;padding: 20px 0;" placeholder="Type message..." id="chat_msg" name="chat_msg"></textarea>
