<?php
	...
	$myq=mysqli_query($conn,"select * from `userss` where userid='".$_SESSION['id']."'");
	...
	elseif ($cpassword!=$myqrow['password']){
		...
		mysqli_query($conn,"update `userss` set username='$musername', password='$newpassword', uname='$mname' where userid='".$_SESSION['id']."'");
		?>
		<script>
