...
?>
					...
					<form action="place_order_repurchase.php" method="post" enctype="multipart/form-data" >
						...
						<input class="input" type="text" name="price" id="price" value="<?php echo $price?>" readonly>
							</div>
						...
						<div class="form-group">Mobile:
						   	...
						   	<div class="form-group">
						   	    Gender:
						   	    		<input lass="input" type="text" name="gender" value="<?php echo $gender?>" style="width: 40%" readonly>
									
										
							</div>
							<div class="form-group">Birthday:
								<input class="input" type="text" name="birthdate" value="<?php echo $bithdate?>" readonly>
							</div>
