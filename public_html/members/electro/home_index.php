		...
		<div class="section">
			...
			<div class="container">
				...
				<div class="row">
					...
					<!-- Products tab & slick -->
			<?php include('login_get_stores.php') ?>
					<!-- /Products tab & slick -->
				</div>
				<!-- /row -->
			</div>
							...
							<div class="products-tabs">
								...
								while($Womenrow=mysqli_fetch_array($Women)){
										...
										<div class="product">
											...
											<div class="add-to-cart">
											<a href="add_repurchase_store.php?id='.$Womenrow['sp_id'].'" >
												<button class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i> Place Order</button>
													</a>
											</div>
										</div>
							...
							<div class="products-tabs">
								...
								while($Menrow=mysqli_fetch_array($Men)){
										...
										<div class="product">
											...
											<div class="add-to-cart">
											<a href="add_repurchase_store.php?id='.$Menrow['sp_id'].'" >
												<button class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i> Place Order</button>
													</a>
											</div>
										</div>
							...
							<div class="products-tabs">
								...
								while($Electronicsnrow=mysqli_fetch_array($Electronics)){
										...
										<div class="product">
											...
											<div class="add-to-cart">
											<a href="add_repurchase_store.php?id='.$Electronicsnrow['sp_id'].'" >
												<button class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i> Place Order</button>
													</a>
											</div>
										</div>
							...
							<div class="products-tabs">
								...
								while($Gadgetsrow=mysqli_fetch_array($Gadgets)){
										...
										<div class="product">
											...
											<div class="add-to-cart">
											<a href="add_repurchase_store.php?id='.$Gadgetsrow['sp_id'].'" >
												<button class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i> Place Order</button>
													</a>
											</div>
										</div>
							...
							<div class="products-tabs">
								...
								while($Toysrow=mysqli_fetch_array($Toys)){
										...
										<div class="product">
											...
											<div class="add-to-cart">
											<a href="add_repurchase_store.php?id='.$Toysrow['sp_id'].'" >
												<button class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i> Place Order</button>
													</a>
											</div>
										</div>
							...
							<div class="products-tabs">
								...
								while($Sportsrow=mysqli_fetch_array($Sports)){
										...
										<div class="product">
											...
											<div class="add-to-cart">
											<a href="add_repurchase_store.php?id='.$Sportsrow['sp_id'].'" >
												<button class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i> Place Order</button>
													</a>
											</div>
										</div>
							...
							<div class="products-tabs">
								...
								while($Beautyrow=mysqli_fetch_array($Beauty)){
										...
										<div class="product">
											...
											<div class="add-to-cart">
											<a href="add_repurchase_store.php?id='.$Beautyrow['sp_id'].'" >
												<button class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i> Place Order</button>
													</a>
											</div>
										</div>
							...
							<div class="products-tabs">
								...
								while($Babiesrow=mysqli_fetch_array($Babies)){
										...
										<div class="product">
											...
											<div class="add-to-cart">
											<a href="add_repurchase_store.php?id='.$Babiesrow['sp_id'].'" >
												<button class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i> Place Order</button>
													</a>
											</div>
										</div>
							...
							<div class="products-tabs">
								...
								while($Homerow=mysqli_fetch_array($Home)){
										...
										<div class="product">
											...
											<div class="add-to-cart">
											<a href="add_repurchase_store.php?id='.$Homerow['sp_id'].'" >
												<button class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i> Place Order</button>
													</a>
											</div>
										</div>
							...
							<div class="products-tabs">
								...
								while($EAccessoriesrow=mysqli_fetch_array($EAccessories)){
										...
										<div class="product">
											...
											<div class="add-to-cart">
											<a href="add_repurchase_store.php?id='.$EAccessoriesrow['sp_id'].'" >
												<button class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i> Place Order</button>
													</a>
											</div>
										</div>
							...
							<div class="products-tabs">
								...
								while($EDesignrow=mysqli_fetch_array($Design)){
										...
										<div class="product">
											...
											<div class="add-to-cart">
											<a href="add_repurchase_store.php?id='.$EDesignrow['sp_id'].'" >
												<button class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i> Place Order</button>
													</a>
											</div>
										</div>
							...
							<div class="products-tabs">
								...
								while($Booksrow=mysqli_fetch_array($Books)){
										...
										<div class="product">
											...
											<div class="add-to-cart">
											<a href="add_repurchase_store.php?id='.$Booksrow['sp_id'].'" >
												<button class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i> Place Order</button>
													</a>
											</div>
										</div>
							...
							<div class="products-tabs">
								...
								while($Motorbikesrow=mysqli_fetch_array($Motorbikes)){
										...
										<div class="product">
											...
											<div class="add-to-cart">
											<a href="add_repurchase_store.php?id='.$Motorbikesrow['sp_id'].'" >
												<button class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i> Place Order</button>
													</a>
											</div>
										</div>
							...
							<div class="products-tabs">
								...
								while($Carrow=mysqli_fetch_array($Car)){
										...
										<div class="product">
											...
											<div class="add-to-cart">
											<a href="add_repurchase_store.php?id='.$Carrow['sp_id'].'" >
												<button class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i> Place Order</button>
													</a>
											</div>
										</div>
							...
							<div class="products-tabs">
								...
								while($CarAccessoriesrow=mysqli_fetch_array($CarAccessories)){
										...
										<div class="product">
											...
											<div class="add-to-cart">
											<a href="add_repurchase_store.php?id='.$CarAccessoriesrow['sp_id'].'" >
												<button class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i> Place Order</button>
													</a>
											</div>
										</div>
							...
							<div class="products-tabs">
								...
								while($Petrow=mysqli_fetch_array($Pet)){
										...
										<div class="product">
											...
											<div class="add-to-cart">
											<a href="add_repurchase_store.php?id='.$Petrow['sp_id'].'" >
												<button class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i> Place Order</button>
													</a>
											</div>
										</div>
							...
							<div class="products-tabs">
								...
								while($Antiquesrow=mysqli_fetch_array($Antiques)){
										...
										<div class="product">
											...
											<div class="add-to-cart">
											<a href="add_repurchase_store.php?id='.$Antiquesrow['sp_id'].'" >
												<button class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i> Place Order</button>
													</a>
											</div>
										</div>
							...
							<div class="products-tabs">
								...
								while($Gardeningrow=mysqli_fetch_array($Gardening)){
										...
										<div class="product">
											...
											<div class="add-to-cart">
											<a href="add_repurchase_store.php?id='.$Gardeningrow['sp_id'].'" >
												<button class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i> Place Order</button>
													</a>
											</div>
										</div>
							...
							<div class="products-tabs">
								...
								while($Propertyrow=mysqli_fetch_array($Property)){
										...
										<div class="product">
											...
											<div class="add-to-cart">
											<a href="add_repurchase_store.php?id='.$Propertyrow['sp_id'].'" >
												<button class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i> Place Order</button>
													</a>
											</div>
										</div>
