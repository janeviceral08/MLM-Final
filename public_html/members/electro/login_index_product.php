...
<style type="text/css">
    ...
    $query_prod = mysqli_query($con,"SELECT *, COUNT(product) as prods  FROM `store_product` where cat = '$prod' and status = 1");
				...
				<div class="row">
					<div class="col-md-12">
						<ul class="breadcrumb-tree">
							...
							<li class="active"><?php echo $row_prod['cat'];?> (<?php echo $row_prod['prods']; ?> Products)</li>
						</ul>
					</div>
				</div>
				<!-- /row -->
				...
				<div class="row">
					...
					<div id="store" class="col-md-15">
						...
						<div class="store-filter clearfix">
							...
							<ul class="store-grid">
							    <a href="add_prod.php">
								<li class="active"><i class="fa fa-plus-square-o" style="font-size: 15px"></i></li>
                                </a>
							</ul>
						</div>
						<!-- /store top filter -->
	...
	<?php 
	            $prod = $_GET['prod'];
										...
										$h=mysqli_query($con,"select * from store_product where cat = '$prod' and status = '1' ");
...
<?php 
										$h=mysqli_query($con,"SELECT store_product.*, repurchase_qty.* FROM `store_product` JOIN repurchase_qty ON store_product.product=repurchase_qty.prod_name where store_product.cat = '$prod'and store_product.status = 1");
								while($hrow=mysqli_fetch_array($h)){
