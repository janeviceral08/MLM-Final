...
<style type="text/css">
    ...
    $query_prod = mysqli_query($con,"SELECT *, COUNT(product) as prods  FROM `store_product` where user_store_name = '$searchs' and status = 1");
					...
					<div class="row">
						...
						<div class="col-md-3">
							<div class="header-logo">
								<a href="home_index.php" class="logo">
						...
						<div class="col-md-6">
							<div class="header-search">
								<form action="login_search_from_store.php" action="get">
									<select class="input-select"  onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);">
									    <option value="">Search inStore</option>
										<option value="login_search_prod.php">Products</option>
										<option value="login_search_store.php">Store</option>
									</select>
									<input class="input-select" name="store" value="<?php echo $searchs ?>" style="display: none">
				...
				<div class="row">
					<div class="col-md-12">
						<ul class="breadcrumb-tree">
						    <?php
	$storename = $_GET['id'];
    $query_store = mysqli_query($con,"SELECT *, COUNT(product) as prods  FROM `store_product` where user_store_name = '$storename' and status = 1");
...
?>
	...
	<?php 
	$storename = $_GET['id'];
										$h=mysqli_query($con,"select * from store_product where user_store_name = '$storename' and status = '1' ");
								while($hrow=mysqli_fetch_array($h)){
							...
							<div class="col-md-4 col-xs-6">
								<div class="product">
									<div class="product-img">
										<img src="imageView.php?image_id='.$hrow['sp_id'].'" alt="" style="height:270px">
										<div class="product-label">
											<span class="sale">'.$hrow['quantity'].' Item Left</span>
										</div>
									</div>
						...
						<?php
								            ...
								            $h=mysqli_query($con,"SELECT store_product.*, repurchase_qty.* FROM `store_product` JOIN repurchase_qty ON store_product.product=repurchase_qty.prod_name where store_product.user_store_name = '$storename' and store_product.status = 1");
								while($hrow=mysqli_fetch_array($h)){
							...
							<div class="col-md-4 col-xs-6">
								<div class="product">
									...
									<div class="product-body">
										<p class="product-category">'.$hrow['user_store_name'].'</p>
										<h3 class="product-name"><a href="#">'.$hrow['product'].'</a></h3>
										<h4 class="product-price">₱'.number_format($hrow['price'],2).'</h4>
										<div class="product-rating">
											<i class="fa fa-star"></i>
											<i class="fa fa-star"></i>
											<i class="fa fa-star"></i>
