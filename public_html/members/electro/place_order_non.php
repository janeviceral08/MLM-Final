...
if(isset($_POST['Submit'])){
 ...
 $oursubject ='Order Receipt';
			    	...
			    	$query = mysqli_query($con,"insert into join_request(`first_name`,`last_name`,`username`,`email`,`gender`,`birthdate`,`address`,`notes`,`product`,`price`,`date_requested`,`store_email`,`order_id`,`contact`,`age`,`middle_name`,`nationality`,`password`,`refered`,`classification`,`status`,`qty`) values('$first_name','$last_name','non-membershp','$email','$gender','$birthdate','$address','$note','$product','$price',NOW(),'$store_email','$generated_pin-$t','$contact','$age','$middle_name','$nationality','non-membershp','$referral','2','pending','$qty')");
				...
				<div class="row">
					...
					<div class="col-md-5 order-details">
						...
						<div class="order-summary">
							...
							<div class="order-col">
								<div><strong>TOTAL</strong></div>
								<div><strong>₱'.number_format($price*$qty,2).'</strong></div>
							</div>
						</div>
