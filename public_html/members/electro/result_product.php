...
<style type="text/css">
				...
				<div id="responsive-nav">
					...
					<ul class="main-nav nav navbar-nav">
						<li class="active"><a href="index.php">Home</a></li>
														<?php 
													$searchs= mysqli_real_escape_string($con,$_GET['search']);	
    $query_prod = mysqli_query($con,"SELECT *, COUNT(product) as prods  FROM `store_product` where product LIKE '%$searchs%' and status = 1");
	...
	<?php 
					$search= mysqli_real_escape_string($con,$_GET['search']);
										$h=mysqli_query($con,"select * from store_product where product LIKE '%$search%'  and status = 1 ");
		...
		<?php 
										$h=mysqli_query($con,"SELECT store_product.*, repurchase_qty.* FROM `store_product` JOIN repurchase_qty ON store_product.product=repurchase_qty.prod_name where store_product.product LIKE '%$search%'and store_product.status = 1");
								while($hrow=mysqli_fetch_array($h)){
