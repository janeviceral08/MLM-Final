...
<style type="text/css">
				...
				<div id="responsive-nav">
					...
					<ul class="main-nav nav navbar-nav">
						<li class="active"><a href="index.php">Home</a></li>
														<?php 
													$searchs= $_GET['search'];	
    $query_prod = mysqli_query($con,"SELECT *, COUNT(product) as prods  FROM `store_product` where 	user_store_name LIKE '%$searchs%' and status = 1");
			...
			<div class="container">
				...
				<div class="row">
					...
					$search= mysqli_real_escape_string($con,$_GET['search']);
										$store=mysqli_query($con,"SELECT *, COUNT(*) as products FROM store_product where user_store_name LIKE '%$search%'  and status = 1 GROUP BY user_store_name ");
									
								while($storerow=mysqli_fetch_array($store)){
	...
	<div class="product-widget">
								...
								<i class="fas fa-store" style="color: red; font-size: 50px;"></i>
								</div>
								<div class="product-body">
									<h3 class="product-name"><a href="show_store.php?id='.$storerow['user_store_name'].'">'.$storerow['user_store_name'].'</a></h3>
									<p class="product-price">'.$storerow['products'].' Products</p>
								</div>
							</div>
	...
	<?php 
					$search= mysqli_real_escape_string($con,$_GET['search']);
										$h=mysqli_query($con,"select * from store_product where user_store_name LIKE '%$search%'  and status = 1 ");
