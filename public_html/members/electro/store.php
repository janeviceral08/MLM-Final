...
<style type="text/css">
	...
	<?php 
										$h=mysqli_query($con,"select * from store_product where user_store_name = '$store' and status = '1' ");
								while($hrow=mysqli_fetch_array($h)){
						 if($hrow['from_user'] == 'admin' && $hrow['product'] == 'VGX Kit +' ){
						 ...
						 else if($hrow['from_user'] == 'admin' && $hrow['product'] == 'VGX Kit' ){
							...
							<div class="col-md-4 col-xs-6">
								<div class="product">
									...
									<div class="add-to-cart">
									    	<a href="edit_product.php?id='.$hrow['sp_id'].'" >
										<button class="add-to-cart-btn"><i class="fa fa-edit"></i> Edit</button> </a>
											<a href="delete_prod.php?id='.$hrow['sp_id'].'" >
										<button class="add-to-cart-btn"><i class="fa fa-trash"></i> Delete</button> </a>
									</div>
								</div>
							</div>
							<!-- /product -->
