				...
				<div class="container-fluid">
					<div class="row">
                    	...
                    	<div class="table-responsive">
                             	...
                             	<?php
										...
										while($pdrow=mysqli_fetch_array($pd)){
											...
											<tr>
												...
												<td align="right">
													<?php 
														$subtotal=$pdrow['p_price']*$pdrow['p_qty'];
                         ...
                         <form action="order_history.php" style="margin: 20px">
         <input type="submit" value="Back to Order History" class="btn" style="background-color: #3a6520; color: white"/>
      </form>
