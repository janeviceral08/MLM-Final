...
if(isset($_GET['join_user'])){
	...
	if($flag==1){
		...
		$query = mysqli_query($con,"insert into user(`email`,`password`,`mobile`,`address`,`account`,`under_userid`,`side`,`user_level`) values('$email','$password','$mobile','$address','$account','$under_userid','$side','$level')");
		...
		while($total_count>0){
			...
			if($temp_under_userid!=""){
				...
				if($income_data['day_bal']<$capping){
					...
					if($i != 7){
					$q=mysqli_query($con,"insert into income_history(`user_id`,`amount`,`level`,`date`) values('$temp_under_userid', '$user_Compensation', '$i','$date' )");
					ChromePhp::log($q);
					}
                ...
                <div class="row">
                	<div class="col-lg-4">
                    	<form method="get">
                            ...
                            <div class="form-group">
                                <label>Side</label><br>
                                <input type="radio" name="side" value="A"> A
                                <input type="radio" name="side" value="B"> B
								<input type="radio" name="side" value="C"> C
								<input type="radio" name="side" value="D"> D
                                <input type="radio" name="side" value="E"> E
								<input type="radio" name="side" value="F"> F
								<input type="radio" name="side" value="G"> G
                                <input type="radio" name="side" value="H"> H
								<input type="radio" name="side" value="I"> I
								<input type="radio" name="side" value="J"> J
                                <input type="radio" name="side" value="K"> K
								<input type="radio" name="side" value="L"> L
                            </div>
